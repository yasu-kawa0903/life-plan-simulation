        ...
        <div className="flex flex-col space-y-2">
          <div className="flex items-center">
            <input 
              ...
              type="number"
              name="housingData.purchasePlan.fireInsurance.amount"
              value={formData.housingData.purchasePlan.fireInsurance.amount}
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              type="number"
              name="housingData.purchasePlan.fireInsurance.cycle"
              value={formData.housingData.purchasePlan.fireInsurance.cycle}
              onChange={onFormChange}
              className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
        ...
        <div className="flex flex-col space-y-2">
          <div className="flex items-center">
            <input
              ...
              type="number"
              name="housingData.purchasePlan.earthquakeInsurance.amount"
              value={formData.housingData.purchasePlan.earthquakeInsurance.amount}
              onChange={onFormChange}
              className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <span className="ml-2 text-gray-600">万円</span>
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              type="number"
              name="housingData.purchasePlan.earthquakeInsurance.cycle"
              value={formData.housingData.purchasePlan.earthquakeInsurance.cycle}
              onChange={onFormChange}
              className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <span className="ml-2 text-gray-600">年</span>
