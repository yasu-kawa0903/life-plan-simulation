...
function MaintenanceForm({ formData, onFormChange }) {
  const isMansion = formData.housingData.ownedHouse.dwellingType === 'マンション';
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center">
              <input
                ...
                type="number"
                name="housingData.ownedHouse.maintenanceReserve"
                value={formData.housingData.ownedHouse.maintenanceReserve}
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center">
              <input
                id="commonAreaFee"
                type="number"
                name="housingData.ownedHouse.commonAreaFee"
                value={formData.housingData.ownedHouse.commonAreaFee}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <span className="ml-2 text-gray-600">万円/月</span>
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center">
              ...
              <input
                ...
                type="number"
                name={`housingData.ownedHouse.repairCosts[${index}].amount`}
                value={formData.housingData.ownedHouse.repairCosts?.[index]?.amount || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                type="number"
                name={`housingData.ownedHouse.repairCosts[${index}].cycle`}
                value={formData.housingData.ownedHouse.repairCosts?.[index]?.cycle || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ...
            <div className="flex items-center">
              ...
              <input
                id={`repairCostNextPayment${index}`}
                type="number"
                name={`housingData.ownedHouse.repairCosts[${index}].nextPaymentAge`}
                value={formData.housingData.ownedHouse.repairCosts?.[index]?.nextPaymentAge || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center">
              ...
              <input
                ...
                type="number"
                name={`housingData.ownedHouse.otherMaintenanceCosts[${index}].amount`}
                value={formData.housingData.ownedHouse.otherMaintenanceCosts?.[index]?.amount || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <span className="ml-2 text-gray-600">万円</span>
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                type="number"
                name={`housingData.ownedHouse.otherMaintenanceCosts[${index}].cycle`}
                value={formData.housingData.ownedHouse.otherMaintenanceCosts?.[index]?.cycle || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <span className="ml-2 text-gray-600">年</span>
            ...
            <div className="flex items-center">
              <span className="text-sm text-gray-600 mr-2 min-w-[70px]">次回支払</span>
              <input
                id={`otherMaintenanceNextPayment${index}`}
                type="number"
                name={`housingData.ownedHouse.otherMaintenanceCosts[${index}].nextPaymentAge`}
                value={formData.housingData.ownedHouse.otherMaintenanceCosts?.[index]?.nextPaymentAge || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <span className="ml-2 text-gray-600">歳</span>
