          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center">
              ...
              <input
                ...
                type="number"
                name={`housingData.ownedHouse.otherCosts[${index}].amount`}
                value={formData.housingData.ownedHouse.otherCosts?.[index]?.amount || ''}
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                type="number"
                name={`housingData.ownedHouse.otherCosts[${index}].cycle`}
                value={formData.housingData.ownedHouse.otherCosts?.[index]?.cycle || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ...
            <div className="flex items-center">
              ...
              <input
                id={`otherCostNextPayment${index}`}
                type="number"
                name={`housingData.ownedHouse.otherCosts[${index}].nextPaymentAge`}
                value={formData.housingData.ownedHouse.otherCosts?.[index]?.nextPaymentAge || ''}
                onChange={onFormChange}
                className="shadow-sm border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
